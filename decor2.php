<head>
        <title>DDHShirtz | THE HAPPYSAD NEON</title>
...
<div class="container">
    <div class="row ">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="images/decor2a.jpg" class="d-block w-100" alt="...">
                    </div>
                <div class="carousel-item">
                    <img src="images/decor2b.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="images/decor2c.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div class="col-6 rightContainer">
            <p class="title">The HappySad Neon</p>
            <p class="price">₱23,600.00</p>

            <!-- Form -->
            <form action="decor2.php" method=get>
