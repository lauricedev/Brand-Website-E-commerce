<head>
        <title>DDHShirtz | THE SELF DESTRUCTIVE TEE</title>
...
<div class="container">
    <div class="row ">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="images/top1a.jpg" class="d-block w-100" alt="...">
                    </div>
                <div class="carousel-item">
                    <img src="images/top1b.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="images/top1c.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div class="col-6 rightContainer">
            <p class="title">The Self Destructive Tee</p>
