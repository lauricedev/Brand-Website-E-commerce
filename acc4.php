<head>
        <title>DDHShirtz | THE VERY GHOUL CAP</title>
    ...
    <div class="row navStuff">
        ...
        <div class="row navStuff">
            <div class="col">
                ...
                <div class="dropdown">
                    <a href="accessories.html"><button class="dropbtn current" href>ACCESSORIES</button></a>
                </div>
...
<div class="container">
    <div class="row ">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="images/acc4a.jpg" class="d-block w-100" alt="...">
                    </div>
                <div class="carousel-item">
                    <img src="images/acc4b.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="images/acc4c.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div class="col-6 rightContainer">
            <p class="title">The Very Ghoul Cap</p>
            <p class="price">₱1,500.00</p>

            <!-- Form -->
            <form action="acc4.php" method=get>
