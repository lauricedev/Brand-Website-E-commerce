<head>
        <title>DDHShirtz | THE SELF MISINFORMATION TEE</title>
...
<div class="container">
    <div class="row ">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="images/top2a.jpg" class="d-block w-100" alt="...">
                    </div>
                <div class="carousel-item">
                    <img src="images/top2b.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="images/top2c.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div class="col-6 rightContainer">
            <p class="title">The Misinformation Tee</p>
            <p class="price">₱1,600.00</p>

            <!-- Form -->
            <form action="top2.php" method=get>
