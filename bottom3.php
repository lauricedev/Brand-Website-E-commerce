<head>
        <title>DDHShirtz | THE NOCTURNE CHILL PANT</title>
...
<div class="container">
    <div class="row ">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="images/bottom3a.jpg" class="d-block w-100" alt="...">
                    </div>
                <div class="carousel-item">
                    <img src="images/bottom3b.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="images/bottom3c.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div class="col-6 rightContainer">
            <p class="title">The Nocturn Chill Pant</p>
            <p class="price">₱2,900.00</p>

            <!-- Form -->
            <form action="bottom3.php" method=get>
