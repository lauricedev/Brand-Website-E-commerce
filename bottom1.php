<head>
        <title>DDHShirtz | THE PLAID POLLUTION PANTS</title>
    ...
    <div class="row navStuff">
        ...
        <div class="row navStuff">
            <div class="col">
                ...
                <div class="dropdown">
                    <a href="bottoms.html"><button class="dropbtn current">BOTTOMS</button></a>
                </div>
...
<div class="container">
    <div class="row ">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="images/bottom1a.jpg" class="d-block w-100" alt="...">
                    </div>
                <div class="carousel-item">
                    <img src="images/bottom1b.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="images/bottom1c.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div class="col-6 rightContainer">
            <p class="title">The Plaid Pollution Pants</p>
            <p class="price">₱4,600.00</p>

            <!-- Form -->
            <form action="bottom1.php" method=get>
